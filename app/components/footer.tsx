...
export default function Footer() {
  ...
  return (
    <footer className={`relative bg-acoustic-dark border-t border-acoustic-border overflow-hidden ${hasStickyBar ? "pb-20 md:pb-0" : ""}`}>
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none select-none absolute -right-6 -bottom-16 font-display italic text-[9rem] md:text-[14rem] leading-none text-acoustic-gold/[0.04]"
      >
        響
      </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 border border-acoustic-gold/40 flex items-center justify-center">
            ...
            <p className="font-body text-[13px] text-acoustic-muted leading-relaxed max-w-xs">
