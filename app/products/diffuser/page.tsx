        ...
        <div className="max-w-7xl mx-auto">
          <Breadcrumb
            items={[
              ...
              { label: "Acoustic Diffuser", href: "/products/diffuser" },
            ]}
          />
          ...
          <p className="font-body text-base text-acoustic-muted mt-4 max-w-xl">
            Precision-engineered sound wave scattering
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-3 pt-2">
              <a
                href="https://wa.me/60197697886?text=Hi%2C%20I%27m%20interested%20in%20the%20Acoustic%20Diffuser.%20Could%20you%20provide%20more%20information%20and%20pricing%3F"
                target="_blank"
      ...
      <div className="bg-acoustic-dark border-t border-acoustic-border acoustic-grid py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-acoustic-cream font-light mb-8">
            About Acoustic Diffuser
          </h2>
          <div className="max-w-3xl space-y-5 font-body text-sm text-acoustic-muted leading-[1.9]">
            <p>
              Our Acoustic Diffuser is designed to create a more balanced and natural sound environment by effectively
              scattering sound waves across a wide frequency range. The mathematically optimised surface patterns ensure
              uniform dispersion, preventing unwanted acoustic artefacts while maintaining the natural character of your room.
            </p>
            <p>
              Available in multiple design variations including pyramid patterns, cubic blocks, and complex geometric
              cutouts, each diffuser can be customised to meet specific acoustic requirements and aesthetic preferences.
              Choose from various materials including premium hardwood, high-density foam, and composite materials, each
              offering unique acoustic properties and visual appeal.
            </p>
            <p>
              Our diffusers are available in multiple colour options including natural wood finishes, classic black and
              white, vibrant yellow, and custom colours to match your space. Whether for ceiling installation in
              professional studios or wall mounting in home listening rooms, these diffusers combine acoustic excellence
