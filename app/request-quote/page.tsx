      ...
      <section className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <Input type="email" name="email" id="email" value={formData.email} onChange={handleInputChange} autoComplete="email" required placeholder="your@email.com" className={fieldClass} />
          </div>
          ...
          {/* Room size */}
          <div>
            <label htmlFor="roomSize" className={labelClass}>Approximate Room Size (sq ft)</label>
            <Input type="number" name="roomSize" id="roomSize" value={formData.roomSize} onChange={handleInputChange} placeholder="e.g. 200" className={fieldClass} />
          </div>
          ...
          <p className="font-body text-[11px] text-acoustic-dim text-center leading-relaxed">
            Clicking above opens WhatsApp with your request pre-filled. We respond within business hours: 9:00–17:00, daily.
          </p>
        </form>
      </section>
    </div>
